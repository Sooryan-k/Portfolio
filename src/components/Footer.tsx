...
export default function Footer() {
  return (
    <footer id="contact" className="mx-auto max-w-5xl px-5 py-20 sm:px-6 sm:py-28">
      <Reveal>
        <div className="rounded-3xl border border-border bg-surface/40 px-6 py-14 text-center sm:px-12">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-accent">
            Get in touch
          </p>
          <h2 className="mx-auto mt-4 max-w-2xl font-display text-3xl font-semibold leading-tight text-fg sm:text-5xl">
            Let&apos;s build something great together.
          </h2>
          <p className="mx-auto mt-5 max-w-xl font-sans text-sm text-muted sm:text-base">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <a
              href={socials.email}
              className="inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3 font-mono text-sm font-medium text-on-accent transition hover:bg-accent-soft"
            >
              <Mail size={16} />
              {profile.email}
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-border bg-fill px-6 py-3 font-mono text-sm text-fg transition hover:bg-fill-strong"
            >
              <FileText size={16} />
              Resume
